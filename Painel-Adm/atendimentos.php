...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Atendimento</a>
		...
		<div class="modal-body">
			...
			<form method="post">
				...
				<div class="form-group">
					...
					<input type="hidden" id="campo_antigo"  name="campo_antigo" value="<?php echo @$descricao ?>" required>
