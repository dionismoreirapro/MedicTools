...
<div class="cabecalho">
		...
		<div class="row">
			<div class="col-sm-4">	
			  <img src="../../img/logo_painel.png" width="900">
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-9">	
				   ...
				   <span class="dados">Telefone: <?php echo $telefone ?> &nbsp; &nbsp; Email: <?php echo $email ?> </span><br>
				    <span class="dados">Endereço: jd novo oassis - Maringá- Paraná - PR </span><br>
...
<div class="footer">
 <p style="font-size:12px" align="center">Desenvolvido por Dionis R Moreira</p> 
</div>
