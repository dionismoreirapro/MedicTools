...
<body>
	...
	<nav class="navbar navbar-light bg-light">
		<div class="col-md-12">
		<img class="float-left" src="../img/Logo_Medic_Trans.png">
		...
		<div class="row">
			<div class="col-md-3 col-sm-12 mb-4">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link <?php echo @$item6ativo ?>" id="v-pills-messages-tab"  href="index.php?acao=<?php echo $item6 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Estoque Baixo</a>
					<a target="_blank" class="nav-link <?php echo @$item7ativo ?>" id="v-pills-messages-tab"  href="rel/rel_remedios_class.php?acao=<?php echo $item7 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="far fa-user mr-1"></i>Relatório de Remédios</a>
